...
public class EmployeeMaster {
    ...
    private Byte ISAUTOEMAIL;
    @Column(name="OUTLET")
    private String OUTLET;
    @Column(name="ISPOSCUSTOMER")
    private Byte ISPOSCUSTOMER;
    @Column(name="ISEDITPOSPRODUCTPRICE")
    private Byte ISEDITPOSPRODUCTPRICE;
    @Column(name="ISSALESMAN")
    private Byte isSalesman;
    @Column(name="ISCASHIER")
    private Byte isCashier;
    @Column(name="ISTEMPORARY_EMP")
    private Byte isTemporaryEmp;
    @Column(name="ISSALARYBY")
