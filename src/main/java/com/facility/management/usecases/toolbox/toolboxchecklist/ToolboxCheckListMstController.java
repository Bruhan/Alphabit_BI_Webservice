...
import com.facility.management.persistence.models.PredefinedSafetyMst;
import com.facility.management.persistence.models.PredfineChecklistCategory;
import com.facility.management.persistence.models.SafetyMst;
...
import com.facility.management.usecases.toolbox.model.ToolboxDao;
...
public class ToolboxCheckListMstController {
    ...
    public ResponseEntity<?> getAllToolboxList(HttpServletRequest request, @RequestParam(required=false) String fromDate) throws Exception {
        ...
        resultsDao.setResults(ToolboxsummaryList);
