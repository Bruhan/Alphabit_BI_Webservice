...
@Repository("DashboardAnalyticsDao")
public class DashboardAnalyticsDaoImpl implements DashboardAnalyticsDao {
    @Autowired
    private SessionFactory sessionFactory;

    @Override
    public Double getAverageBookPerSale(String plant, String outlet, String terminal) {
        ...
        try {
            ...
            double totalBills = ((Number) result[1]).longValue();
    ...
    @Override
    public Double getAverageOrderValue(String plant, String outlet, String terminal) {
        Session session = sessionFactory.openSession();
        double avgOrder = 0.0;
    ...
    @Override
    public Double getAverageSellingPrice(String plant, String outlet, String terminal) {
        Session session = sessionFactory.openSession();
    ...
    @Override
    public Double getSalesDensity(String plant, String outlet, String terminal) {
        Session session = sessionFactory.openSession();
    ...
    @Override
    public Double getTotalRevenue(String plant, String outlet, String terminal) {
        Session session = sessionFactory.openSession();
    ...
    @Override
    public Double getTotalUnitsSold(String plant, String outlet, String terminal) {
        Session session = sessionFactory.openSession();
    ...
    @Override
    public Double getGrossMargin(String plant, String outlet, String terminal) {
        Session session = sessionFactory.openSession();
    ...
    @Override
    public Double getAverageSalesPerEmployee(String plant,String outlet) {
        Session session = sessionFactory.openSession();
    ...
    @Override
    public Double getSalesGrowthRate(String plant, String fromDate, String toDate, String outlet, String terminal, Integer periodType) {
    ...
    @Override
    public Double getNetProfitMargin(String plant, String fromDate, String toDate, String outlet, String terminal) {
        Session session = sessionFactory.openSession();
    ...
    @Override
    public Double getOperatingExpensesRatio(String plant, String fromDate, String toDate, String outlet) {
        Session session = sessionFactory.openSession();
    ...
    @Override
    public List<Map<String, Object>> getBestSellingItems(String plant, String outlet, String terminal,int topCount) {
        Session session = sessionFactory.openSession();
        ...
        try {
            ...
            sql.append("SELECT d.ITEM,d.ITEMDESC,SUM(d.QTYOR) AS QTY ");
            sql.append("FROM ");
            sql.append(plant);
            sql.append("_DODET d ");
            sql.append("LEFT JOIN ");
            sql.append(plant);
            sql.append("_DOHDR h ON d.DONO=h.DONO WHERE 1=1 ");
            ...
            Query query = session.createSQLQuery(sql.toString());
            query.setParameter("count",topCount);
            if (outlet != null && !outlet.trim().isEmpty()) {
                query.setParameter("outlet", outlet);
            }
            if (terminal != null && !terminal.trim().isEmpty()) {
